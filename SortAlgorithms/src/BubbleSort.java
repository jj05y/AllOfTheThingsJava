...
public class BubbleSort {
	public static void main(String args[]) {
		...
		randomize(myInts);
		//display the array
		JOptionPane.showMessageDialog(null, buildMessage(myInts, "Random Ints"));
		// now the bubble sort,
		bubbleSort(myInts);
		//display the array
		JOptionPane.showMessageDialog(null, buildMessage(myInts, "Bubble Sorted Ints"));
		...
		//display the array
		JOptionPane.showMessageDialog(null, buildMessage(myInts, "Selection Sorted Ints"));
